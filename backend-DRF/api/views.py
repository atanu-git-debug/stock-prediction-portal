...
class StockPredictionApiView(APIView):
    def post(self,request):
        ...
        if serializer.is_valid():
            ...
            plot_img = save_plot(plot_img_path=plot_img_path)
            print(plot_img)
            ...
            plot_100_dma = save_plot(plot_img_path=plot_img_path)
            ...
            plot_200_dma = save_plot(plot_img_path=plot_img_path)
            ...
            plot_prediction = save_plot(plot_img_path=plot_img_path)
